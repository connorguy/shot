  ...
  return (
    <div className="inspector">
      ...
      <div className="card tight keys">
        ...
        <span><kbd>P</kbd> prompt an agent</span><span><kbd>⌫</kbd> delete</span><span><kbd>⌘D</kbd> duplicate</span><span><kbd>⌘Z</kbd> undo</span><span><kbd>Z</kbd> fit</span><span><kbd>[</kbd><kbd>]</kbd> panels</span><span><kbd>F</kbd> full screen</span><span><kbd>⌥</kbd>-drag no snap</span>
      </div>
      <div className="btn-row">
